			...
			public void run() {
				...
				if(principal == null) {
					menuBuilder.addItems(
							__inject__(MenuItemBuilder.class).setCommandableName("Compte utilisateur").setCommandableIcon(Icon.USERS).addChild(
					...
					menuBuilder.addItems(
							__inject__(MenuItemBuilder.class).setCommandableName("Paramétrage").setCommandableIcon(Icon.GEARS).addChild(
									...
									,__inject__(MenuItemBuilder.class).setCommandableName("Role").addChild(
											__inject__(MenuItemBuilder.class).setCommandableName("Type de role")
											,__inject__(MenuItemBuilder.class).setCommandableName("Role")
									)
							...
							,__inject__(MenuItemBuilder.class).setCommandableName("Administration des comptes").setCommandableIcon(Icon.USERS).addChild(
									...
									,__inject__(MenuItemBuilder.class).setCommandableName("Tester la connection à un compte").setCommandableIcon(Icon.PLUS)
